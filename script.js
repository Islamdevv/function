...
// function func2(arr) {
//   let max = arr.reduce((acc, el) => (acc.length > el.length ? acc : el));
//   console.log(max);
// }
// func2(arr);
...
// function func4(str) {
//   let arr = str.split("");
//   let res = arr.filter((el) => el !== "e" && el !== "o");
...
// и возвращает массив чисел start 1 параметр end 2 парамет
...
// function func7(limit) {
//   let num = 0;
//   for (let i = 50; i < limit; i *= 2) {
//     console.log(i);
//     num = i;
//   }
...
// Есть функция checkTask(arr, a, b) которая принимает в аргументы массив из чисел, начальное число и конечное число. При помоши метода filter необходимо вернуть новый массив в котором будут числа в диапазоне от числа a до числа b включительно.
// Пример:
// [1,12,45,3,27,344,122,205], a = 22, b = 200. Результат: [45, 27, 122];
// const checkTask = (arr, a, b) => { }

// function func8(arr, a, b) {
//   let result = arr.filter((el) => el > a && el < b);
//   console.log(result);
// }
// func8([1, 12, 45, 3, 27, 344, 122, 205], 22, 200);
...
// let result = arr
//   .map((el) => el.toString())
//   .filter((el) => el[0] == 1 || el[0] == 2 || el[0] == 5);
...
// let result = newArr.filter((el) => el[0] == 1 || el[0] == 2 || el[0] == 5);
// console.log(result);
...
// let result = arr.reduce((acc, el) => acc + el).length;
// console.log(result);
...
// let result = arr.map((el, idx) => (idx === 1 ? el.toUpperCase() : el));
// console.log(result);
...
// let arr9 = ["john", "JACOB", "jinGleHeimer", "schmidt"];
// let res = arr9.map((el) => el[0].toUpperCase() + el.slice(1));
// console.log(res);

// 10. Вам дан массив со строками ['Баяман', 'Калмамат']. Поменяйте местами первые буквы строк.
// let arr = ["Баяман", "Калмамат"];
// let firstName = arr[0][0].toUpperCase() + arr[1].slice(1);
// let secondName = arr[1][0].toUpperCase() + arr[0].slice(1);
...
// let str = "тестингg";
// function task12(str, idx) {
//   let res = str
//     .split("")
//     .map((el) =>
//       el.length % 2 !== 0 ? el[el.length / 2 - 0.5] : el[el.length / 2 - 1]
//     );
//   console.log(res);
// }
// task12(str);
// 13. Вам дан массив с числами [5, -3, 13, -7, 45]. Верните сумму всех положительных чисел.
// 14. Вам дан массив с числами [5, -54, 13, -7, 45, -15, -34]. Верните суму всех отрицательных чисел, которые больше 10.
...
// let result = arr.map((el, idx) => console.log(el + idx));
